...
<template>
  <div class="page">
    ...
    <footer>
      У каждого пользователя свои списки и галочки. Данные хранятся на сервере (Node.js + SQLite), идентификатор пользователя — в cookie браузера. Начальные списки добавляются автоматически при первом заходе. Отметки сохраняются отдельно на каждый день.
    </footer>
  </div>
</template>